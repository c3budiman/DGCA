          ...
          <div class="row">
              <div class="col-12">
                  <div class="card-box table-responsive">
                      <h3>Pengguna Terdaftar : <span id="nama_perusahaannya"></span> </h3>
...
@section('js')
  ...
  <script type="text/javascript">
    ...
    table = $('.datatable2').DataTable({
        ...
        ajax: '{{ route('report/company/json') }}',
        columns: [
            {data: 'DT_Row_Index', name: 'DT_Row_Index', orderable: false, searchable: false},
            {data: 'nama', name: 'users.nama'},
            {data: 'email', name: 'users.email'},
            {data: 'status_user', name: 'status_user', orderable: false, searchable: false},
            {data: 'nama_perusahaan', name: 'perusahaan.nama_perusahaan'},
            {data: 'status_user_perusahaan', name: 'users.approved_company', orderable: false, searchable: false},
            {data: 'address', name: 'users.address'},
            {data: 'ktp', name: 'users.ktp'},
