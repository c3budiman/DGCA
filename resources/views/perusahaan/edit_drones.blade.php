...
@section('content')
  ...
  <?php
   ...
   ?>
    <form enctype="multipart/form-data" data-parsley-validate id="example-advanced-form" action="/perusahaan/drones/{{$manages->id}}" method="post">
      <input type="hidden" name="_method" value="put">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
              ...
              <select required id="model" class="form-control provinsi" name="model" data-placeholder="{{ $manages-> model}}">
                <option value="{{ $manages-> model}}">{{ $manages-> model}}</option>
        ...
        <fieldset>
          <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select required id="model" class="form-control provinsi" name="termofowenership" data-placeholder="{{ $manages-> termofowenership}}">
                  <option value="{{ $manages-> termofowenership}}">{{ $manages-> termofowenership}}</option>
        ...
        <fieldset>
          <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select required id="termofposession" class="form-control provinsi" name="termofposession" data-placeholder="{{ $manages-> termofposession}}">
                  <option value="{{ $manages-> termofposession}}">{{ $manages-> termofposession}}</option>
            ...
            <div class="col-md-6 form-group">
                ...
                <input name="reference" type="text" parsley-trigger="change" data-parsley-group="block3" class="form-control" value="{{ $manages-> reference}}">
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input name="namapemberisewa" type="text" parsley-trigger="change" data-parsley-group="block3" class="form-control" value="{{ $manages-> namapemberisewa}}">
                </div>
                <div class="col-md-6 form-group">
                    <label for="phone">Alamat</label>
                    <input name="alamatpemberisewa" type="text" parsley-trigger="change" data-parsley-group="block3" class="form-control" value="{{ $manages-> alamatpemberisewa}}">
                </div>

                <div class="col-md-6 form-group">
                    <label for="phone">Email</label>
                    <input name="emailpemberisewa" type="text" parsley-trigger="change" data-parsley-group="block3" class="form-control" value="{{ $manages-> emailpemberisewa}}">
                </div>
                <div class="col-md-6 form-group">
                    <label for="phone">Nomor Telepon</label>
                    <input name="nomorteleponpemberisewa" type="text" parsley-trigger="change" data-parsley-group="block3" class="form-control" value="{{ $manages-> nomorteleponpemberisewa}}">
                </div>
...
@section('js')
  ...
  $(document).ready(function() {
      ...
      $("#btn_proof_of_ownership").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{url(action('AdminPerusahaanController@uploadDokumenUAS'))}}',
            dataType: "json",
  ...
  $(document).ready(function() {
      ...
      $("#btn_pic_of_drones_with_sn").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{url(action('AdminPerusahaanController@uploadPesawatSn'))}}',
            dataType: "json",
            processData: false, // important
            contentType: false, // important
            data: uploadedFile,
  ...
  $(document).ready(function() {
      ...
      $("#btn_pic_of_drones").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{url(action('AdminPerusahaanController@uploadPesawat'))}}',
            dataType: "json",
            processData: false, // important
            contentType: false, // important
            data: uploadedFile,
  ...
  $(document).ready(function() {
      ...
      $("#btn_scan_proof_of_ownership").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: '{{url(action('AdminPerusahaanController@uploadPenguasaan'))}}',
            dataType: "json",
            processData: false, // important
            contentType: false, // important
            data: uploadedFile,
