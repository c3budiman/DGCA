          ...
          <div class="card-box">
              ...
              <ul class="nav nav-pills navtab-bg nav-justified pull-in ">
                  <li class="nav-item">
                      <a href="#home1" data-toggle="tab" aria-expanded="false" class="nav-link active">
                          <i class="fi-monitor mr-2"></i> Edit Menu Content
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="#profile1" data-toggle="tab" aria-expanded="true" class="nav-link ">
                          <i class="fi-head mr-2"></i> Manage Submenu
                      </a>
                  </li>
              </ul>
              ...
              <div class="tab-content">
                  ...
                  <div class="tab-pane" id="profile1">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">Mengatur Submenu untuk menu frontend : {{$front->nama}}</h4>
                            <p class="text-muted font-14 m-b-30">
                                disini kamu bisa mengatur submenu untuk menu frontend : {{$front->nama}}
                            </p>
      ...
      $("#submit").click(function(){
        $.ajax({
            ...
            success: function (data, status) {
                ...
                swal({
                  title: "Berhasil!",
                  text: request.responseJSON.success,
                  icon: "success",
                  button: "okay",
                });
            },
